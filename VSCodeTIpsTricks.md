...
![side by side install](/VSCodemedia/side-by-side-install.png)

## Getting Started

Open the **Welcome** page to get started with the basics of VS Code. **Help** > **Welcome**.

![welcome page](/VSCodemedia/welcome_page.png)

Includes the **Interactive Playground**.

![interactive playground](/VSCodemedia/interactive_playground.png)
...
![command palette](/VSCodemedia/OpenCommandPalatte.gif)
...
![keyboard references](/VSCodemedia/keyboard-references.png)
...
![Quick Open](/VSCodemedia/QuickOpen.gif)
...
![shell command](/VSCodemedia/setup_shell-command.png)
...
![all cli commands](/VSCodemedia/vscode-cli-commands.png)
...
![errors and warnings](/VSCodemedia/Errors_Warnings.gif)
...
![change syntax](/VSCodemedia/change_syntax.gif)
...
![Preview themes](/VSCodemedia/PreviewThemes.gif)

Additionally, you can install and change your File Icon themes.

![File icon themes](/VSCodemedia/PreviewFileIconThemes.gif)
...
![Keyboard Reference Sheet](/VSCodemedia/KeyboardReferenceSheet.png)
...
![customize keyboard shortcuts](/VSCodemedia/KeyboardShortcuts.gif)
...
![font ligatures](/VSCodemedia/font-ligatures-annotated.png)
...
![language based settings](/VSCodemedia/lang-based-settings.png)
...
![install extensions](/VSCodemedia/InstallExtensions.gif)

## Extension recommendations

Click the Extensions Activity Bar button. Then click **Show Recommended Extensions** in the **More** (...) button menu.

![show recommended extensions](/VSCodemedia/ShowRecommendedExtensions.gif)
...
![Integrated terminal](/VSCodemedia/integrated_terminal.png)
...
![toggle side bar](/VSCodemedia/toggle_side_bar.gif)
...
![zen mode](/VSCodemedia/zen_mode.gif)
...
![split editors](/VSCodemedia/split_editor.gif)
...
![navigate editors](/VSCodemedia/navigate_editors.gif)
...
![create and open file](/VSCodemedia/create_open_file.gif)
...
![navigate history](/VSCodemedia/navigate_history.gif)
...
![navigate to file](/VSCodemedia/navigate_to_file.gif)
...
![multi cursor](/VSCodemedia/multi_cursor.gif)

![multi cursor second example](/VSCodemedia/editingevolved_multicursor.gif)

Add more cursors to current selection.

![add cursor to all occurrences of current selection](/VSCodemedia/add_cursor_current_selection.gif)
...
![Join lines](/VSCodemedia/JoinLines.gif)
...
![copy line down](/VSCodemedia/copy_line_down.gif)
...
![shrink expand selection](/VSCodemedia/shrink_expand_selection.gif)
...
![Find by symbol](/VSCodemedia/find_by_symbol.gif)
...
![navigate to line](/VSCodemedia/navigate_to_line.gif)
...
![undo cursor position](/VSCodemedia/undo_cursor_position.gif)
...
![move line up and down](/VSCodemedia/move_line.gif)
...
![trailing whitespace](/VSCodemedia/trim_whitespace.gif)
...
![code formatting](/VSCodemedia/code_formatting.gif)
...
![code folding](/VSCodemedia/code_folding.gif)
...
![select current line](/VSCodemedia/select_current_line.gif)
...
![navigate to beginning and end of file](/VSCodemedia/beginning_end_file.gif)
...
![toggle readme preview](/VSCodemedia/toggle_preview.gif)
...
![markdown sync](/VSCodemedia/markdown-preview-sync.gif)

# IntelliSense

Anytime, try <kbd>ctrl+space</kbd> to trigger the Suggestions widget.

![intellisense](/VSCodemedia/intellisense.gif)
...
![package json intellisense](/VSCodemedia/package_json_intellisense.gif)

## Emmet syntax

[Support for Emmet syntax](https://code.visualstudio.com/docs/languages/html#_emmet-snippets).

![emmet syntax](/VSCodemedia/emmet_syntax.gif)
...
![git icon](/VSCodemedia/git_icon.png)

**Side by side**

Default is side by side diff.

![git diff side by side](/VSCodemedia/git_side_by_side.png)

**Inline view**

Toggle inline view by clicking the **More** (...) button in the top right and selecting **Switch to Inline View**.

![more git button](/VSCodemedia/more_button.png)

![git inline](/VSCodemedia/git_inline.png)
...
![diff_review_pane](/VSCodemedia/diff_review_pane.png)
...
![switch branches](/VSCodemedia/switch_branches.gif)
...
![git stage all](/VSCodemedia/git_stage_all.gif)
...
![undo last commit](/VSCodemedia/undo_last_commit.gif)
...
![git gutter indicators](/VSCodemedia/editingevolved_gutter.png)
...
![configure debugging](/VSCodemedia/configure_debug.gif)

## Breakpoints and stepping through

Place breakpoints next to the line number. Navigate forward with the Debug widget.

![debug](/VSCodemedia/node_debug.gif)

## Data inspection

Inspect variables in the Debug panels and in the console.

![data inspection](/VSCodemedia/debug_data_inspection.gif)
...
![task runner](/VSCodemedia/task_runner.gif)
